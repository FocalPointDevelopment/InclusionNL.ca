...
<div class="container" role="main">
    <div class="content">
        ...
        <div class="page-banner">
            <img class="banner-image" src="<?php echo get_template_directory_uri();?>/images/Services-Header-1024x402.webp" aria-hidden="true"/>
        ...
        <div class="small-body">
            ...
            <h2 style="text-align: left">How we can help</h2>
            <p>InclusionNL provides support to government, businesses and organizations. We will work with you to make your space and your events inclusive.</p>
            ...
            ?>
                    <div class="service-card">
                            <div class="service-card-image">
                                <img src="<?php echo get_field('featured_photo');?>" alt="<?php the_title(); ?>">
                            </div>
